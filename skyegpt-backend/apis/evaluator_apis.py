...
from services.dependencies import AggregatedAgentResponseService, get_agent_response_service
...
async def generate_agent_response_with_context(
    ...
    with_context = True
    response_dict = await agent_response_service.aggregated_agent_response(query, conversation_id, with_context)

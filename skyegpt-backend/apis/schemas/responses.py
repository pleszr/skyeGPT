"""Schema definitions for API response models."""
...
class CreateConversationIdResponse(BaseModel):
    """Response model for returning a newly created conversation ID."""
...
class AgentResponse(BaseModel):
    ...
    curr_context: Optional[Any] = Field(
        None, description="The context associated with the conversation after generation."
    )
...
class PlaygroundResponse(BaseModel):
    ...
    model_config = {
        "json_schema_extra": {"examples": [{"response": "This is the generated text from the playground model."}]}
    }
...
class DownloadResponse(BaseModel):
    ...
    folder_content: Dict[str, Any] = Field(..., description="Dictionary representing the nested folder/file structure.")
            ...
            "examples": [
                {
                    "folder_content": {
                        "name": "skye-10.0",
                        "type": "folder",
                        "children": [{"name": "requirements.txt", "type": "file"}],
                    }
                }
            ]
        }
...
class ImportResponse(BaseModel):
    ...
    model_config = {"json_schema_extra": {"examples": [{"number_of_documents": 42}]}}
...
class ConversationResponse(BaseModel):
    ...
    model_config = {"json_schema_extra": {"examples": [{"conversation": ["ModelRequest", "ModelResponse"]}]}}

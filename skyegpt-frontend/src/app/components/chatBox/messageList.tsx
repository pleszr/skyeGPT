...
const MessageList: React.FC<MessageListProps> = ({
  ...
  return (
      <div
          className="chatMessages flex flex-col gap-6 p-4 sm:p-6 lg:p-8 overflow-y-auto scroll-smooth bg-white flex-shrink-0 rounded-[30px] h-[60vh] max-h-[90vh] min-h-0"
...
const LoadingIndicator: React.FC<{
  ...
  return (
      <div className="self-start max-w-[90%] sm:max-w-[80%] flex flex-col">
        <div className="contents p-4 sm:p-5 lg:p-6 rounded-[30px] bg-[#ececec] text-black rounded-tr-[30px] rounded-bl-[0] shadow-sm">
          <div className="flex items-center space-x-2">
            {loadingContent}
          </div>
        </div>
    ...
    ({ msg, index, isLoading, showFeedbackControls, feedbackType, currentRatingError, onRate, onPromptFeedback }: MemoizedMessageProps) => {
      ...
      return (
          <div className={`flex flex-col ${isUser ? 'items-end' : 'items-start'} w-full`}>
            {isUser ? (
                <div className="p-4 sm:p-5 lg:p-6 rounded-[30px] max-w-[90%] sm:max-w-[80%] transition-opacity duration-300 shadow-sm bg-gradient-to-r from-[#1ea974] to-[#17a267] self-end text-white rounded-br-[0]">
                ...
                <div className="self-start flex flex-col w-auto max-w-[90%] sm:max-w-[80%]">
                  <div className="p-4 sm:p-5 lg:p-6 rounded-[30px] transition-opacity duration-300 shadow-sm bg-[#ececec] text-black rounded-bl-[0]">
